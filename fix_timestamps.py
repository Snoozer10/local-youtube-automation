...
sys.modules[__name__] = _FacadeProxy("youtube_automation.timeline.fix_timestamps")

if __name__ == "__main__":
    import runpy
    runpy.run_module("youtube_automation.timeline.fix_timestamps", run_name="__main__")
