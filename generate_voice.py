...
import youtube_automation.audio.tts_generator as tts_mod  # noqa: E402
from youtube_automation.audio.tts_generator import *  # noqa: E402, F401, F403


class _FacadeProxy(types.ModuleType):
    """Dynamic facade proxy ensuring 100% backward compatibility and bidirectional
    monkeypatching synchronization across youtube_automation.audio.tts_generator.
    """
...
sys.modules[__name__] = _FacadeProxy(
    ...
    sync_modules=[
        ...
        "youtube_automation.audio.tts_generator",
    ],
)
...
if __name__ == "__main__":
    ...
    with warnings.catch_warnings():
        ...
        runpy.run_module("youtube_automation.audio.tts_generator", run_name="__main__")
