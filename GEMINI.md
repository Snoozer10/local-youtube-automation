...
- Browser, adaptive Audacity and encoder leases fence shared devices and short publication operations. Immutable final filenames precede atomic activation pointers; byte-verified clip caches include render/tool recipes. These are primitives, not a finished durable stage scheduler; TTS and legacy tools do not all participate.
