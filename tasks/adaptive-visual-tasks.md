...
- [ ] G4h Generate and editorially inspect three shot plans for factual caution, idiom meaning, visual progression, consistency and crop choice.
  - Snoozer in progress: rejected a 6-shot/71-second plan for dull pacing, a 15-shot plan with empty entity IDs, and a 19-shot plan that literalized popsicle and organ-to-ice-cream jokes. Plan v2 now resolves channel/script cadence, requires explicit framing and visible entities, bounds motion and shot length, chains references, and blocks obvious figurative transformations. No plan is accepted and no images were generated.
...
| G4–G6 | Three real channel profiles, caption excerpts, analyzed briefs, local bilingual OCR and tested source-audio import are ready. The owner-provided Snoozer Hokkaido master is imported and transcribed, and three weak shot-plan drafts were preserved as rejected evidence. | Professor and Soldier matching media; an accepted Snoozer shot plan; three live visual previews; user editorial feedback; subsequent full episodes. |
