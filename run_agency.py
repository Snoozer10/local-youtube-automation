...
def resolve_step_timeout() -> int:
    ...
    try:
        ...
        print(f"[WARNING] Invalid STEP_TIMEOUT_SECONDS={raw!r}; falling back to default 7200s cap.")
        return 7200
    if value <= 0:
        return 0
...
def _execute_folder_steps(
    ...
    for step in folder_steps:
        ...
        try:
            ...
            notify_per_step = get_config_value(
                "TELEGRAM_NOTIFY_PER_STEP", "false"
