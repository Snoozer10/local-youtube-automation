...
sys.modules[__name__] = _FacadeProxy("youtube_automation.prompts.socratic_engine")
...
if __name__ == "__main__":
    ...
    with warnings.catch_warnings():
        ...
        runpy.run_module("youtube_automation.prompts.socratic_engine", run_name="__main__")
