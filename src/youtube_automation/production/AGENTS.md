...
- A changed stage recipe journals and archives mutable downstream activations under `.adaptive_history/` before the new attempt. Restart reconciliation completes that archive first; content-addressed accepted images, immutable renders and reusable caches remain preserved.
