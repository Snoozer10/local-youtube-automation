...
sys.modules[__name__] = _FacadeProxy("youtube_automation.prompts.prompt_enhancer")
...
if __name__ == "__main__":
    ...
    with warnings.catch_warnings():
        ...
        runpy.run_module("youtube_automation.prompts.prompt_enhancer", run_name="__main__")
